const DATA_RATE_VALUES = [ 95, 190, 380, 760 ];
const BANDWIDTH_VALUES = [ 12.5, 20, 25, 30, 35, 50, 70, 100 ];
const HIGHPASS_FILTER_CUTOFF_FREQUENCY_VALUES = [ 51.4, 27, 13.5, 7.2, 3.5, 1.8, 0.9, 0.45, 0.18, 0.09, 0.045, 0.018, 0.009 ];

const POWER_DOWN = "Power-down";
const SLEEP = "Sleep";
const NORMAL = "Normal";
const FALSE = "false";
const TRUE = "true";
const HIGH = "High";
const LOW = "Low";
const PUSH_PULL = "Push-pull";
const OPEN_DRAIN = "Open drain";
const _4_WIRE = "4-wire";
const _3_WIRE = "3-wire";
const BIG_ENDIAN = "Big endian";
const LITTLE_ENDIAN = "Little endian";
const _250_DPS = "250dps";
const _500_DPS = "500dps";
const _2000_DPS = "2000dps";
const CONTINUOUS_UPDATE = "Continous update";
const NOT_UPDATED_UNTIL_READING = "Output registers not updated until reading";
const LPF1 = "LPF1";
const HPF = "HPF";
const LPF2 = "LPF2";
const REBOOT_MEMORY_CONTENT = "Reboot memory content";
const BYPASS = "Bypass";
const FIFO = "FIFO";
const STREAM = "Stream";
const STREAM_TO_FIFO = "Stream-to-Fifo";
const BYPASS_TO_STREAM = "Bypass-to-Stream";
const AND = "And";
const OR = "Or";
const NORMAL_WITH_RESET = "Normal with reset.";
const REFERENCE_SIGNAL_FOR_FILTERING = "Reference signal for filtering.";
const AUTORESET_ON_INTERRUPT = "Autoreset on interrupt.";

const L3GD20Dictionaries = {
